...
export const Avatar = ({ initials, size = "md" }) => {
  ...
  return (
    <div
      className={`${sizes[size]} rounded-full flex items-center justify-center font-bold text-white flex-shrink-0 shadow-sm border-2 border-white/20`}
...
export const Toggle = ({ checked, onChange }) => (
  <button
    ...
    style={{ background: checked ? "#ff6d34" : "#d1d5db" }}
  >
    <div
...
export const PrimaryButton = ({ children, onClick, className = "", icon: Icon }) => (
  <button
    ...
    style={{ background: "linear-gradient(135deg, #ff6d34, #ff8255)" }}
  >
...
export const GreenButton = ({ children, onClick, className = "", icon: Icon }) => (
  <button
    ...
    style={{ background: "linear-gradient(135deg, #00bea3, #15d1b7)" }}
  >
    {Icon && <Icon size={16} strokeWidth={2.5} />}
    {children}
  </button>
